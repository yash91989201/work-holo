...
import { getDmPresenceChannel } from "@/lib/communications/dm-realtime";
...
export function useDmPresence(conversationId: string | null) {
  ...
  useEffect(() => {
    ...
    const channelName = getDmPresenceChannel(conversationId);
