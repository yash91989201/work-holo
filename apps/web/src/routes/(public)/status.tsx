    ...
    items: [
      {
        ...
        answer: "The status page checks our core infrastructure every 60 seconds. Any disruptions are reflected here almost instantaneously.",
      },
      {
        question: "Can I get notifications for maintenance?",
        answer: "Yes, you can subscribe to updates via email, SMS, or webhook by clicking the 'Subscribe to updates' button at the top of the page.",
      },
      {
        question: "What features are affected during maintenance?",
        answer: "Unless specified in the active incident banner, minor updates usually only cause short connection drops to real-time sockets. Core data remains unaffected.",
      },
      {
        question: "Where can I find uptime history?",
        answer: "You can view detailed historical uptime by clicking on the 'View detailed metrics' links in the transparency section above, which hosts up to 90 days of logs.",
      },
    ],
  };
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-[1480px] px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="max-w-xl">
                <span className="mb-6 inline-block font-bold tracking-widest text-xs uppercase text-gray-500">
                  REAL-TIME SERVICE STATUS
                </span>
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl text-balance leading-tight">
                  All systems are<br />operational.
                </h1>
                <p className="mt-6 text-lg tracking-tight leading-8 text-gray-500 max-w-md text-balance">
                  Monitor our platform's real-time performance, uptime statistics, and notifications about scheduled server maintenance affecting messaging or team creation.
                </p>
              </div>
        ...
        <section className="w-full bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center flex flex-col items-center">
            <h2 className="text-3xl font-extrabold italic text-[#2e375b] tracking-tight sm:text-5xl leading-tight text-balance">
              StatusCheck+
            </h2>
            <p className="mt-8 text-2xl font-medium sm:text-3xl italic text-[#475467] leading-relaxed text-balance">
              'Our commitment to transparency ensures that every team knows exactly when our systems are at peak performance, allowing for uninterrupted collaboration.'
            </p>
            <div className="mt-8">
              <span className="block font-bold text-gray-900">Daniel Roberts</span>
              <span className="block text-sm text-gray-500 font-medium mt-1">Infrastructure Lead, StatusCheck+</span>
            </div>
          </div>
        </section>
        ...
        <section className="w-full bg-white py-12 border-b border-gray-100">
          <div className="mx-auto max-w-[1480px] px-6 lg:px-8">
            <p className="text-center text-xs font-bold tracking-[0.2em] uppercase text-gray-400 mb-8 sm:mb-12">
              TRUSTED BY TEAMS WHO REQUIRE 100% RELIABILITY
            </p>
            <div className="flex flex-wrap items-center justify-between gap-8 sm:gap-12 lg:gap-16 opacity-40 grayscale">
              {trustedLogos.map((logo) => (
                <span key={logo} className="text-xl font-bold font-sans text-gray-600 tracking-tight">
                  {logo}
                </span>
              ))}
            </div>
