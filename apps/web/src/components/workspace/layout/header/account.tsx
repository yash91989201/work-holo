  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="relative h-9 w-9 rounded-full p-0" variant="ghost">
      ...
      <DropdownMenuContent align="end" className="w-96">
        <div className="relative h-32 w-full overflow-hidden rounded-t-lg bg-linear-to-br from-violet-500 via-purple-500 to-pink-500">
