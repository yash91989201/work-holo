...
type HireFeaturesProps = {
  items: FeatureItem[];
  title: string;
  description?: string;
};

export function HireFeatures({ items, title, description }: HireFeaturesProps) {
  return (
          ...
          {items.map((item, idx) => {
            ...
            return (
              <div
                ...
                key={idx}
              >
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-green-500 font-bold text-white shadow-green-500/20 shadow-lg">
