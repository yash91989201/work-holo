      ...
      {files.length > 0 ? (
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          {files.map((file) => {
            ...
            return (
              <div
                className="group relative flex flex-col overflow-hidden rounded-xl border border-border/60 bg-card transition-all duration-150 hover:bg-accent/40 hover:shadow-sm"
                key={file.id}
              >
                ...
                <div className="flex flex-1 flex-col p-3">
                  ...
                  <div className="mt-auto flex flex-col gap-2 pt-2 opacity-75">
                    <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground">
                      <IconHash className="h-3.5 w-3.5" />
                      <span className="truncate">{file.channelName}</span>
                    </div>
