  ...
  return (
    <section className="relative w-full">
      ...
      <div className="relative -mb-1 w-full overflow-hidden bg-[#7C5CFF]">
        ...
        >
          <path d="M0,0 L0,20 Q720,160 1440,20 L1440,0 Z" fill="white" />
        </svg>
      </div>

      {/* Purple content area */}
      <div className="bg-[#7C5CFF] px-4 pt-10 pb-20 sm:px-6 lg:px-8">
      ...
      <div className="relative -mt-1 w-full overflow-hidden bg-white">
        <svg
          ...
          viewBox="0 0 1440 120"
        >
          <path d="M0,0 L0,100 Q720,-40 1440,100 L1440,0 Z" fill="#7C5CFF" />
        </svg>
      </div>
    </section>
  );
