...
"description": "Modern businesses use technology in almost every aspect of their operations, so call center helpdesks must be able to handle several types of services.",
"items": [
{
"id": "s1",
"number": "01",
"title": "Account Administration",
"description": "Setting up accounts for new employees, resetting passwords, and adjusting access levels.",
...
"description": "Assistance with installing, updating, or using various software applications.",
...
"description": "Troubleshooting devices from printers to laptops to ensure tech works properly.",
"features": ["Device troubleshooting", "Peripheral setup", "Connectivity issues"],
"icon": "shield"
}
],
...
"description": "Advanced quality control systems and reliable troubleshooting processes for same quality support."
},
{
"icon": "zap",
"title": "Access to Tech Expertise",
"description": "Instant access to hundreds of knowledgeable agents with specialized technological experience."
},
{
"icon": "globe",
"title": "Less Downtime",
"description": "24/7 tech support and agents to keep your system running and minimize network downtime."
}
],
"showcaseImage": {
...
{
"id": 1,
"question": "What Is the Difference Between a BPO Team and a Call Center in Tech Support?",
"answer": "A call center primarily focuses on communication aspects like taking calls, while BPO teams can also handle back-office and administrative functions."
},
{
"id": 2,
"question": "How Can Outsourcing Tech Support Grow My Business?",
"answer": "Hiring a third-party call center allows you to focus on core operations and reinvest time and energy into growing your business more efficiently."
},
{
"id": 3,
"question": "How Does Remote Technical Support Work?",
"answer": "Teams use advanced techniques and approved software tools to remotely access devices and resolve complex issues directly over chat or phone."
},
{
  "id": 4,
  "question": "What types of technical issues can your team handle?",
  "answer": "Our agents handle a wide range of issues including software bugs, hardware troubleshooting, network connectivity problems, account access issues, and system performance optimization."
},
{
  "id": 5,
  "question": "Do you provide multi-channel technical support?",
  "answer": "Yes, we offer support across phone, email, live chat, and ticketing systems to ensure your customers receive help through their preferred channel."
},
{
  "id": 6,
  "question": "How do you ensure data security during support sessions?",
  "answer": "We follow strict security protocols, encrypted connections, and compliance standards to ensure all customer data and remote sessions are सुरक्षित and protected."
},
]
},
"cta": {
...
"description": "The Confie team consists of over 1,000 knowledgeable agents who are ready to resolve your technical challenges and troubleshoot complex software.",
"bullets": [
{
