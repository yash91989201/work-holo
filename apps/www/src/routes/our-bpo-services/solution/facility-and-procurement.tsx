...
"services": {
  ...
  "description": "We streamline your operations by managing facilities and procurement workflows efficiently.",
  "items": [
    {
      "id": "s1",
      "number": "01",
      "title": "Facility Management",
      "description": "End-to-end management of infrastructure, maintenance, and operational efficiency.",
      "features": ["Maintenance scheduling", "Asset tracking", "Vendor coordination"],
      "icon": "shield"
    },
    {
      "id": "s2",
      ...
      "description": "Efficient sourcing and purchasing strategies to reduce costs and improve supply chains.",
    ...
    },
    {
      ...
      "description": "Keep your supply chain flowing with accurate inventory monitoring and forecasting.",
      "features": ["Stock monitoring", "Demand forecasting", "Supply optimization"],
      "icon": "zap"
    }
  ],
  ...
  "features": [
    {
      ...
      "description": "We analyze your facility needs, procurement cycles, and vendor dependencies to build a custom workflow."
    },
    {
      "icon": "globe",
      "title": "Vendor & Supply Integration",
      "description": "Seamlessly connect with verified vendors and streamline sourcing, purchasing, and delivery pipelines."
    },
    {
      "icon": "chart",
      "title": "Real-Time Monitoring",
      "description": "Track procurement costs, inventory levels, and facility performance with live KPI dashboards."
    }
  ],
  "showcaseImage": {
...
"items": [
    {
      ...
      "answer": "It involves outsourcing the maintenance, operations, and optimization of physical infrastructure to expert teams."
    },
    {
      "id": 2,
      "question": "How does procurement outsourcing save money?",
      "answer": "By leveraging vendor networks, bulk purchasing, and negotiation strategies, BPO providers reduce operational costs."
    },
    {
      "id": 3,
      "question": "Can services scale with my business?",
      "answer": "Yes, BPO solutions are highly scalable and adjust based on your company’s growth and demand."
    },
    {
      "id": 4,
      "question": "Is my data secure with procurement BPO?",
      "answer": "Yes, advanced security protocols and compliance standards ensure your business data is protected."
    }
  ]
},
"cta": {
