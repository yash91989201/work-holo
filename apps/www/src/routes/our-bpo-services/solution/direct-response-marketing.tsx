...
"description": "Friendly and Fluent Agents Trained to Sell Your Products and Services",
"items": [
{
"id": "s1",
"number": "01",
"title": "Outbound Sales",
"description": "Specialists for a fraction of what you would typically pay.",
"features": [
"Specialized Experts",
"Fractional Cost",
"Advanced Software"
...
"description": "Direct response marketing pushes customers into taking the right action."
}
],
"showcaseImage": {
  ...
  "items": [
    {
      ...
      "answer": "Simple: we want our businesses to grow and reach customers wherever they are."
    },
    {
      "id": 2,
      "question": "What channels are used in direct response marketing?",
      "answer": "Channels include phone calls, SMS campaigns, email outreach, and digital ads designed to trigger immediate customer action."
    },
    {
      "id": 3,
      "question": "How do you measure campaign success?",
      "answer": "We track KPIs like conversion rate, cost per acquisition, response time, and overall ROI to measure success."
    },
    {
      "id": 4,
      "question": "Can campaigns be customized for my audience?",
      "answer": "Yes, all campaigns are tailored based on your target demographics, behavior patterns, and business goals."
    },
    {
      "id": 5,
      "question": "How quickly can campaigns go live?",
      "answer": "Most campaigns can be launched within days after onboarding, depending on complexity and data readiness."
    }
  ]
},
"cta": {
...
"description": "Confie BPO is the single best BPO provider to trust your business with because:",
"bullets": [
{
"label": "Flexible",
...
{
"label": "Affordable",
"detail": "Nearshore location includes unique agent training for your brand."
}
],
...
"description": "Direct response marketing will quickly reveal the limits of almost any company. We provide more than an extra set of hands.",
"bullets": [
{
"label": "Access",
"detail": "Get access to trained professionals who understand this method."
},
{
"label": "Result",
"detail": "It will become your perfect solution for all marketing needs."
}
],
