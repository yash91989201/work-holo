...
"description": "Discover how Confie BPO can turn your company into a growth machine.",
"items": [
{
"id": "s1",
"number": "01",
  ...
  "items": [
    {
      ...
      "answer": "We provide administrative services in customer support, billing, invoicing, procurement, and more."
    },
    {
      "id": 2,
      "question": "What is back office processing in BPO?",
      "answer": "Back office processing involves handling non-customer-facing tasks such as data entry, billing, payroll, and administrative workflows."
    },
    {
      "id": 3,
      "question": "How does outsourcing improve efficiency?",
      "answer": "By automating repetitive tasks and leveraging trained agents, businesses can reduce errors and focus on core operations."
    },
    {
      "id": 4,
      "question": "Is back office outsourcing secure?",
      "answer": "Yes, BPO providers implement strict data security protocols, compliance standards, and access controls to protect sensitive information."
    },
    {
      "id": 5,
      "question": "Can services scale with my business growth?",
      "answer": "Absolutely, BPO solutions are designed to scale up or down based on your operational needs and workload."
    }
  ]
},
"cta": {
...
"description": "We provide support 24 hours a day and 7 days a week to help with anything at any time.",
"bullets": [
{
"label": "24/7 Support",
...
"description": "Meeting all of your needs efficiently and economically while focusing on growth.",
"bullets": [
{
"label": "Efficiency",
